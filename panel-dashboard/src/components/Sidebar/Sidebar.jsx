...
import { useNovedades } from "../../modules/petru/novedades/useNovedades";
import "./Sidebar.css";
              ...
              {section.items.map((item) => {
                ...
                return (
                  ...
                  >
                    <ListItemIcon className="sidebar-item-icon">{item.icon}</ListItemIcon>
                    <ListItemText primary={item.text} />
                    {item.badge && novedades[item.badge] > 0 && (
                      <Chip
                        label={novedades[item.badge]}
                        size="small"
                        color="error"
                        className="sidebar-item-badge"
                        aria-label={`${novedades[item.badge]} pendientes`}
                      />
                    )}
                  </ListItemButton>
                );
