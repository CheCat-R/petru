...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("¡Bienvenido al panel de Pëtru!", "success");
      navigate("/");
    } catch (err) {
      ...
      <Box className="auth-card">
        <Box className="auth-header">
          ...
          <Typography variant="body2" className="auth-subtitle">
            Ingresá con tu cuenta del taller.
          </Typography>
        </Box>
        ...
        <Box className="auth-footer-links">
          <Link to="/olvide" className="auth-link">¿Olvidaste tu contraseña?</Link>
        </Box>
        <Box className="auth-footer-links">
          Las cuentas las crea el taller. Si no tenés acceso, pedíselo a quien administra el panel.
        </Box>
      </Box>
    </Box>
  );
