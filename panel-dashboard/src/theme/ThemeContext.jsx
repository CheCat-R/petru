...
export const CustomThemeProvider = ({ children }) => {
  ...
  const toggleTheme = () =>
    setMode((prev) => {
      ...
      // ⭐ Antes del render, no en el efecto: `useMemo` de abajo lee los tokens
      // del documento durante el render, y el layout effect corre después. Si
      // el atributo se pusiera solo ahí, el tema de MUI se construiría con los
      // tokens del modo anterior — cards blancas en oscuro, navy en claro.
